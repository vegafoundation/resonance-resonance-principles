...
\title{Resonance Principles: Kavramsal Bir Çerçeve}
...
\begin{abstract}
Bu çalışma, Resonance Principles'i Resonance Data ve QIRC paradigması içinde yeni bir kavramsal çerçeve olarak tanıtmaktadır.
